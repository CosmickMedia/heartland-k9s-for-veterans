...
<figure class="hk9-overlap__card hk9-overlap__card--split hk9-featured__card<?php echo $hk9_has_image ? '' : ' hk9-featured__card--no-image'; ?>">
	<?php if ( $hk9_has_image ) : ?>
		<div class="hk9-overlap__media hk9-featured__media">
			...
			<?php echo hk9_image( $hk9_image_id, 'large', [ 'sizes' => '(max-width: 767px) calc(100vw - 32px), (max-width: 1087px) calc(50vw - 32px), 512px', 'alt' => '', 'loading' => 'eager' ] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- core image markup. ?>
		</div>
	<?php endif; ?>
