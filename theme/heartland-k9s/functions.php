...
define( 'HK9_THEME_VERSION', '1.2.0' );
define( 'HK9_THEME_DIR', get_template_directory() );
define( 'HK9_THEME_URI', get_template_directory_uri() );

foreach ( [ 'defaults', 'options', 'section-defaults', 'setup', 'assets', 'icons', 'template-tags', 'menus', 'sections', 'blocks', 'compat', 'plugin-notice', 'template-tags-pages', 'template-tags-records', 'template-tags-blog', 'updater' ] as $hk9_module ) {
