...
<form role="search" method="get" class="hk9-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="search" id="<?php echo esc_attr( $hk9_search_id ); ?>" class="hk9-search__input" name="s" value="<?php echo esc_attr( get_search_query() ); ?>" placeholder="<?php esc_attr_e( 'Search…', 'heartland-k9s' ); ?>" autocomplete="off" required>
