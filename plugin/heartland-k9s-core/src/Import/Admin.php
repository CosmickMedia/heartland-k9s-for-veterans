				...
				<section class="hk9-import__card hk9-import__card--wide" aria-labelledby="hk9-import-run-h">
					...
					<div id="hk9-import-next" class="hk9-import__next" hidden>
						...
						<ol>
							...
							<li><?php esc_html_e( 'Forms: with Gravity Forms installed and active, the "Contact" and "Initial Application Inquiry" forms were created automatically at the end of the run and are now the site\'s forms (Settings → Forms shows their status and a Create button if Gravity Forms was installed later). Without Gravity Forms the built-in forms stay in use.', 'heartland-k9s-core' ); ?> <a href="<?php echo esc_url( admin_url( 'admin.php?page=hk9-settings&tab=forms' ) ); ?>"><?php esc_html_e( 'Settings → Forms', 'heartland-k9s-core' ); ?></a></li>
